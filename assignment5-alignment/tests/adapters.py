...
from transformers.models.gpt2.modeling_gpt2 import Conv1D, GPT2PreTrainedModel
import torch.nn as nn


def _gpt2_init_weights_without_residual_rescale(self, module):
...
GPT2PreTrainedModel._init_weights = _gpt2_init_weights_without_residual_rescale
...
def run_compute_rollout_rewards(
    ...
    """
    from cs336_alignment.util import compute_rollout_rewards
    ...
    Returns:
        tuple[torch.Tensor, dict[str, float]].
            ...
            metadata
                ...
                of rewards).
    """
    from cs336_alignment.util import compute_group_normalized_rewards
...
def run_compute_policy_gradient_loss(
    ...
    """
    from cs336_alignment.util import compute_policy_gradient_loss
...
def run_aggregate_loss_across_microbatch(
    ...
    """
    from cs336_alignment.util import aggregate_loss_across_microbatch
    return aggregate_loss_across_microbatch(per_token_policy_gradient_loss, 
                                                     mask, 
                                                     loss_normalization, 
